...
class NIOS_FTP(unittest.TestCase):
    ...
    def test_093_upload_and_check_files_in_storage_path_after_adding_SA2(self):
        print("\n======================================")
        print("Start TFTP services on Master \n\n")
        print("======================================\n")
        sleep(60)
    ...
    def test_094_delete_all_files_from_path(self):
    ...
    def test_095_Start_HTTP_services_all_members(self):
    ...
    def test_096_Verify_the_HTTP_service_is_running_all_members(self): 
    ...
    def test_097_Check_the_status_of_HTTP_service_are_running(self): 
    ...
    def test_098_grep_httpd_and_validate_PID_on_master(self): 
        
        HTTP.grep_HTTPd_and_validate_PID(config.grid1_master_mgmt_vip)
       
    @pytest.mark.run(order=100)
    def test_099_grep_httpd_and_validate_PID_on_HA_member(self): 
        
        HTTP.grep_HTTPd_and_validate_PID(config.grid1_member1_ha_vip)
        
    @pytest.mark.run(order=101)
    def test_100_grep_httpd_and_validate_PID_on_SA_member(self): 
        
        HTTP.grep_HTTPd_and_validate_PID(config.grid1_member2_vip)
        
    @pytest.mark.run(order=102)
    def test_101_stop_HTTP_service(self):
    ...
    def test_102_Verify_the_HTTP_service_is_stopped_all_members(self): 
    ...
    def test_103_Check_the_status_of_HTTP_service_is_inactive(self): 
    ...
    def test_104_Set_HTTP_ACLs_network_ALLOW(self): 
    ...
    def test_105_validate_HTTP_network_ACLs_added(self): 
    ...
    def test_106_upload_download_after_ACL_set_to_network_with_master(self): 
    ...
    def test_107_upload_download_after_ACL_set_to_network_with_member(self):  
        print("\n======================================\n") 
    ...
    def test_108_delete_HTTP_ACL_Network(self):
        print("\n======================================\n")  
        print("Remove ACLs ")
        print("\n======================================\n")  
    ...
    def test_109_Set_HTTP_ACLs_ipv4_ALLOW(self): 
        print("\n======================================\n")  
        print("Select the network ACLs option.")
        print("\n======================================\n")  
    ...
    def test_110_validate_HTTP_ACLs_ipv4_added(self): 
    ...
    def test_111_upload_download_after_ACL_set_to_network_with_master(self): 
    ...
    def test_112_upload_download_after_ACL_set_to_network_with_member(self):  
        print("\n======================================\n") 
    ...
    def test_113_delete_HTTP_ACL_address(self):
        print("\n======================================\n")  
        print("Remove ACLs ")
        print("\n======================================\n")  
        HTTP.delete_HTTP_ACLs_from_member(0,config.grid1_master_mgmt_vip)
    ...
    def test_114_reboot_and_check_the_status(self):
    ...
    def test_115_restart_and_check_the_status(self):
        print("\n======================================")
    ...
    def test_116_promote_ha_node_and_validate_HTTP_status(self):
        HTTP.start_HTTP_services(1,config.grid1_member1_ha_vip,"HA member")
        print("\n======================================")
    ...
    def test_117_revert_back_to_the_original_state(self):
    ...
    def test_119_upload_and_delete_files_check_status(self):
        '''
    ...
    def test_120_upload_large_files(self):  
        '''
        ...
        HTTP.enable_Allow_grid_member(True)
        HTTP.delete_files_through_path(config.grid1_master_mgmt_vip)
        HTTP.delete_files_through_path(config.grid1_master_vip)
        print(config.grid1_master_mgmt_vip,config.grid1_master_vip)
        sleep(60)
        FTP.Set_storage_limit(1)
        FTP.validate_storage_limit(1)
        log("start","/infoblox/var/infoblox.log",config.grid1_master_mgmt_vip)
    ...
    def test_121_add_permission_group_for_folder(self): 
    ...
    def test_122_upload_crt_file_and_enable_captive_service(self): 
        '''
    ...
    def test_123_take_backup_of_grid_using_FTP_server(self): 
        '''
    ...
    def test_124_perform_operation_on_lan2_ip_FTP(self): 
    ...
    def test_125_perform_operation_on_lan2_ip_TFTP(self): 
    ...
    def test_126_perform_operation_on_lan2_ip_HTTP(self): 
    ...
    def test_127_Cleanup_objects(self): 
        TFTP.delete_files_through_path(config.grid1_master_mgmt_vip)
